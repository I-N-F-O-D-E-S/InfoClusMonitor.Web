...
export const Navbar = () => {
  ...
  return (
    <>
      <header className="navbar">
        <div className="navbar-inner">
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            ...
            {/* Navigation Links */}
            <nav className="navbar-links" style={{ display: "flex", gap: 8 }}>
              <Link
                to="/"
                className={`nav-link ${location.pathname === "/" || (location.pathname.startsWith("/machines") && !location.pathname.includes("/scheduled-tasks")) ? "active" : ""}`}
                style={{
                  fontSize: "13px",
                  fontWeight: 600,
                  color: location.pathname === "/" || (location.pathname.startsWith("/machines") && !location.pathname.includes("/scheduled-tasks")) ? "#38bdf8" : "#94a3b8",
                  textDecoration: "none",
                  display: "flex",
                  alignItems: "center",
                  gap: 6,
                  padding: "6px 12px",
                  borderRadius: "6px",
                  background: location.pathname === "/" || (location.pathname.startsWith("/machines") && !location.pathname.includes("/scheduled-tasks")) ? "rgba(56, 189, 248, 0.1)" : "transparent",
              ...
              <Link
                to="/scheduled-tasks"
                className={`nav-link ${location.pathname === "/scheduled-tasks" ? "active" : ""}`}
                style={{
                  fontSize: "13px",
                  fontWeight: 600,
                  color: location.pathname === "/scheduled-tasks" ? "#38bdf8" : "#94a3b8",
                  textDecoration: "none",
                  display: "flex",
                  alignItems: "center",
                  gap: 6,
                  padding: "6px 12px",
                  borderRadius: "6px",
                  background: location.pathname === "/scheduled-tasks" ? "rgba(56, 189, 248, 0.1)" : "transparent",
                  transition: "all 0.2s ease",
                }}
              >
          ...
          <div className="navbar-actions">
            {/* Botón rápido para Instalar Agente / Agregar Nodo */}
            <button
              ...
              title="Obtener comando 1-clic para instalar o actualizar el agente en cualquier máquina"
            >
              <span>🚀</span> Instalar o Actualizar Agente
            </button>
      ...
      {/* Modal de Instalación / Actualización de Agente */}
      {showInstallModal && (
        <AgentUpdateModal
